...
public class GrenadeScript_Story : MonoBehaviour {
	...
	private IEnumerator ExplosionTimer () 
	{
		...
		foreach (Collider hit in colliders) {
            ...
            {
                hit.gameObject.GetComponent<ZombieScript_Story>().HpChange(50);
            }

            if(hit.GetComponent<Collider>().tag == "SpecialZombie")
            {
                hit.gameObject.GetComponent<SZombieScript_Story>().HpChange(50);
            }
		}
