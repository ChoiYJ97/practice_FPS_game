...
public class TutorialScript : MonoBehaviour
{
    ...
    PlayerScript_Tutorial Player_Tut;
    AutomaticGunScriptLPFP_Tutorial Player_AutoScript_tut;

    string[] textsofguide = {
                        "훈련장에 온 것을 환영한다. 병사여!    <color=#bcbc00>(Enter)</color>",       //0
                        "이제부터 임무에 필요한 기본적인 지식을 알려주겠다.",                         //1
                        "먼저 화면 인터페이스부터 알려 주겠다.",                                      //2
                        "병사가 가진 <color=#bcbc00>총알</color>과 <color=#bcbc00>수류탄</color>의 갯수를 알려준다.",                               //3
                        ...
                        "이제 움직임에 대해 알려주겠다, 시선은 <color=#bcbc00>마우스</color>로 돌린다.",                     //8
                        "감도는 '<color=#bcbc00>[</color>' , '<color=#bcbc00>]</color>' 키로 조절 가능하다.",                //9
                        "이제 <color=#bcbc00>w a s d</color> 로 움직여보자",                                                 //10
                        //wasd누르는 위치

                        "택티컬 나이프는 <color=#bcbc00>F</color> 또는 <color=#bcbc00>Q</color> 를 눌러서 적을 공격할 수 있다.",                    //11
                        "잘했다.",                                                                    //12
                        "나머지 동작키들에 대해서는 후에 설명하겠다.",                                //13

                        "다음 단계는 <color=#0000ff>총알박스</color>를 찾아가라.",                    //14
                        "가까이 다가가면 <color=#bcbc00>E</color> 키를 누르라는 표시가 뜬다.",        //15
                        "누르고 총알을 보급 받도록.",                                                 //16

                        "이제 <color=#bcbc00>R</color> 키를 눌러서 <color=#bcbc00>장전</color>이 가능해 졌다.",              //17
                        ...
                        "구급상자가 있는 위치로 가서 <color=#bcbc00>E</color> 누르면 바로 회복된다.",   //24
                        "마지막으로 수류탄에 대해서 설명하겠다.",                                     //25
                        "<color=#0000ff>수류탄</color>은 <color=#bcbc00>3</color> 을 누르면 사용할 수 있다.",                //26
    ...
    void Start()
    {
        Player_Tut = Player.gameObject.GetComponent<PlayerScript_Tutorial>();
        Player_AutoScript_tut = Player.gameObject.GetComponent<AutomaticGunScriptLPFP_Tutorial>();
    ...
    void Update()
    {
        ...
        */
        ...
        //일반 설명
        if (Input.GetKeyDown(KeyCode.Return) && count == 22 && killedAll)
        {
            changeText(++count);//23
        ...
        //회복 설명 조건문
        if(disP_M <= 3.0f && count == 23 && Input.GetKeyDown(KeyCode.E))
        {
            changeText(++count);//24
        }

        //수류탄 설명 조건문
        if (Input.GetKeyDown(KeyCode.Return) && count >= 24 && count <=30)
        {
